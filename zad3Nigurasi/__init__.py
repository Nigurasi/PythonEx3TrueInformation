...
def get_information(action, type_data, data, logger_name):
    print("If you want to use this as normal program, just run Main.py")

    parser = ParseArgs()

    try:
        arguments = parser.get_parsed_arguments_variables(action,
                                                          type_data,
                                                          data,
                                                          logger_name)
